    ...
    <div class="card-body">
        ...
        <table class="table table-borderless table-hover">
            ...
            <tr>
                ...
                <td><input data-id="{{ $user->id }}" user_id="{{ $user->id }}"  status="{{ $user->status }}"  class="toggle-class" data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="warning" data-offstyle="dark" type="checkbox" {{ $user->status == 'Active' ? 'checked' : '' }}>
                </td>
                <td>
                    @can('user_show')
    ...
    $('.toggle-class').click(function() {        
      ...
      $.ajax({
        ...
        success: function(data) {
          Swal.fire(
            'GREAT!', 'User status changed successfully', 'success')
        }
      });
    });
  }) </script>
