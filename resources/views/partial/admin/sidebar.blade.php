        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    @canany(['subject_access'])
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow waves-effect waves-dark selected" href="javascript:void(0)" aria-expanded="false">
                            <i class="mr-3 mdi mdi-account" aria-hidden="true"></i>
                            <span class="hide-menu">Education Stream</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level
                        @if(request()->is('admin/users') || request()->is('admin/users/*')) in @endif
                        @if(request()->is('admin/roles') || request()->is('admin/roles/*')) in @endif
                        ...
                        @can('users_access')
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark  @if(request()->is('admin/educationstreams')) is_active @endif" href="{{ route('admin.educationstreams.index') }}" aria-expanded="false">
                                <i class="mr-3 mdi mdi-account-multiple" aria-hidden="true"></i>
                ...
                <!-- education stream end -->
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level
                        @if(request()->is('admin/subjects')) in @endif
                        ">
                        @can('subject_access')
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark  @if(request()->is('admin/subjects')) is_active @endif" href="{{ route('admin.subjects.index') }}" aria-expanded="false">
                                <i class="mr-3 mdi mdi-account-multiple" aria-hidden="true"></i>
                                <span class="hide-menu">Show</span>
                            </a>
                        </li>
