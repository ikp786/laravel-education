...
<body>
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand justify-content-center" href="{{url('admin')}}">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                    {{-- <img src="{{ asset('public/admin_assets/images/users/1.jpg') }}" alt="user" class="profile-pic mr-2"> --}}
                                    {{ Auth()->user()->name }}
                            </a>
    ...
    <!-- slim-select -->
    <script src="{{ asset('public/admin_assets/plugins/slim-select/slimselect.min.js') }}"></script>
